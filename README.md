...
Multiplex brings work across agents, models, and providers into one
[KiroCrew](https://github.com/kirodotdev/KiroCrew) overview. Follow each session's
goal, progress, updates, and next action; see where attention is needed; and
return to the conversation to continue the work.
...
This is the initial standalone release (`0.1.0`). The repository
